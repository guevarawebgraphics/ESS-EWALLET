...
class ChangeColumnsInWalletServiceMatrixConfigTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql')->table('wallet_service_matrix_config', function (Blueprint $table) {
