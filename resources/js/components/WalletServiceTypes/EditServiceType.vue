                            ...
                            <hr>
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control mb-2" id="service_type_code" v-model="form.service_code"   v-validate="'required'"  name="service_type_code" placeholder="Code" disabled>
                                    </div>
                                </div> 
                                <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control mb-1" :class="{ 'is-invalid': errors.has('service_type_name') } " id="service_type_name"  v-model="form.service_name" v-on:change="validation()" v-validate="'required'"  name="service_type_name"  placeholder="Name">
                                     <label class="alert text-danger bg-white" v-if="errors.has('service_type_name')"> {{errors.first('service_type_name')}} </label> 
                                </div>
                                </div> 
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label for="service_type_description" class="form-label">Service Type Description</label>
                                        <input type="text" class="form-control mb-1" :class="{ 'is-invalid': errors.has('service_type_description') } " id="service_type_description" v-model="form.service_description" v-on:change="validation()" v-validate="'required'"  name="service_type_description" placeholder="Description">
                                        <label class="alert text-danger bg-white" v-if="errors.has('service_type_description')"> {{errors.first('service_type_description')}} </label> 
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="s-report-inner pr--30 pt--30 mb-3">
                    <div class="icon icon-background"><i class="ti-pencil-alt"></i></div>
                        ...
                        <div class="card-body">
                            ...
                            <router-link :to="{ name: '/st-setup', params: { id: id_value }}" class="btn btn-primary float-right" @click.native="updateDetailsBehavior()" v-if="errors.items.length == 0">Save & Next</router-link> 
                            <button type="button" class="btn btn-primary float-right" v-on:click="showToast()" v-else>Save & Next  </button>
                        </div> 
                    </div>
                </div>
            </div>
