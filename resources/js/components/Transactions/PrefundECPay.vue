                                            ...
                                            <div class="row">
                                                <div class="col-md-4 offset-md-1">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <p class="text-danger" v-if="errors.has('prefundAmount')">{{errors.first('prefundAmount')}}</p>
                                                    </div>
                                                    <hr>
                                                    <!-- ./ Prefund Amount -->
                                                    <!-- Deposited To -->
                                                        <div class="form-group row mt-3">
                                                            <h5 class="control-label custom-label font-weight-bold" for="nameofBank">Deposited to:</h5>
                                                                ...
                                                                <!-- Account Type -->
                                                                    ...
                                                                    <p class="text-danger" v-if="errors.has('accountType')">{{errors.first('accountType')}}</p>
                                                                <!-- ./ Account Type -->
                                                                <!-- Account Name -->
                                                                    ...
                                                                    <p class="text-danger" v-if="errors.has('accountName')">{{errors.first('accountName')}}</p>
                                                                <!-- ./ Account Name -->
                                                                <!-- Account No -->
                                                                    ...
                                                                    <p class="text-danger" v-if="errors.has('accountNo')">{{errors.first('accountNo')}}</p>
                                                                <!-- ./ Account No -->
                                                        </div>
                                                    <!-- ./ Deposited To -->
                                                    <!-- Deposit Slip -->
