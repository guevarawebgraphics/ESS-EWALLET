    ...
    public function create_service_type($service_type_data){  
     ...
     public function show_belong_services($st_id){
                $show_services = DB::connection('mysql')
                                    ->table('service_basetable')
                                    ->join('services','services.id','=','service_basetable.service_id') 
                                    ->join('service_gateway','service_basetable.service_gateway_id','=','service_gateway.id')
